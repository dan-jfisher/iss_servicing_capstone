...
class CameraController:
    ...
    def get_mask_bgr(self, bgr_img):
        ...
        bgr_image_blurred = cv2.GaussianBlur(bgr_img, 0, 0.33)  #############################################################Is this right?
        #                                                                       cv2.bilateralFilter() produces better results at speed cost
    ...
    @staticmethod
    def get_rects_from_mask(pixel_mask):
    ...
    def get_rects_from_current_frame(self):
        ret, bgr_img = self.get_image()
...
def test_camera_to_rect_pipeline():
    ...
    cameraController.get_rects_from_current_frame()
